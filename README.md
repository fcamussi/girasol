...
Ésta aplicación implementa parte de mi trabajo de investigación durante el desarrollo de mi tesis de grado [Conteo de plantas de girasol en cultivos en hileras a partir de imágenes UAV](https://rephip.unr.edu.ar/items/6af3da2a-727e-4b9a-a1e1-5fcf41f4f314) la cuál combina técnicas de Procesamiento Digital de Imágenes con Machine Learning y en la cual se proponen cuatro algoritmos esenciales para el conteo:
